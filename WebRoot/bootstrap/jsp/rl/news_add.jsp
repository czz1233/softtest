...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="container-fluid">
			<form id="news_add_form" class="form-horizontal">
		...
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_add_news">确定</a> 
...
<script type="text/javascript">
	seajs.use("rl/news_add", function(news_add) {
		news_add.init();
	});
</script>