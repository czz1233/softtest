...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="container-fluid">
			<form id="news_edit_form" class="form-horizontal">
			<input type="hidden" name="content" id="content" />
			<input type="hidden" name="id" value="${news.id}" />
					<div class="form-group">
						<label for="title" class="col-sm-3 control-label no-padding-right">新闻标题：</label>
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="title" type="text" name="title" class="width-100" value="${news.title}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="subTitle" type="text" name="subTitle" class="width-100"  value="${news.subTitle}"> 
							</span>
						</div>
					</div>
					<div class="col-xs-12">
						<label class="col-xs-3  no-padding-right">新闻内容：</label>
						<div class="col-xs-12">
							<textarea id="content" name="content1" cols="100" rows="8" style="width:100%;visibility:hidden;"> ${news.content}</textarea>
						</div>
					</div>
			</form>
		</div>
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_edit_news">确定</a> 
			<a href="javascript:;" class="btn btn-default btn-sm btn-round" id="btn_cancel_news">返回</a> 
		</div>
	</div>
	</div>
</div>
...
<script type="text/javascript">
	seajs.use("rl/news_edit", function(news_edit) {
		news_edit.init();
	});
</script>