		...
		<div class="container-fluid">
			<form id="borrow_add_form" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="applyTime" type="text" name="applyTime" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="applyBeginTime" type="text" name="applyBeginTime" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="applyEndTime" type="text" name="applyEndTime" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="applyReason" type="text" name="applyReason" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="applyIdCardImage" type="text" name="applyIdCardImage" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="auditUser" type="text" name="auditUser" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="auditTime" type="text" name="auditTime" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="auditReason" type="text" name="auditReason" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="giveToUser" type="text" name="giveToUser" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="giveToTIme" type="text" name="giveToTIme" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="giveToRemark" type="text" name="giveToRemark" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="backUser" type="text" name="backUser" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="backTime" type="text" name="backTime" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="backRemark" type="text" name="backRemark" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="archive" type="text" name="archive" class="width-100"> 
							</span>
						</div>
					</div>
			</form>
...
<script type="text/javascript">
	seajs.use("rfid/borrow_add", function(borrow_add) {
		borrow_add.init();
	});
</script>