...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">新增档案文件</h3>
	</div>
	<div class="panel-body">
		<div class="container-fluid">
			<form id="archivefile_add_form" class="form-horizontal">
			<input type="hidden" name="content" id="content" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="input-group block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="keyWork" type="text" name="keyWork" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="date form_datetime input-group col-sm-4 no-padding" data-date-format="yyyy-mm-dd hh:ii">
						   <input id="validBeginDate" name="putInTime" readonly="readonly" class="width-100"  type="text"  />
		...
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_add_archivefile">确定</a> 
...
<script type="text/javascript">
	seajs.use("rfid/archivefile_add", function(archivefile_add) {
