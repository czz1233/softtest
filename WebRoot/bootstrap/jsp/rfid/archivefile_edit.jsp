...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">编辑档案文件</h3>
	</div>
	<div class="panel-body">
		<div class="container-fluid">
			<form id="archivefile_edit_form" class="form-horizontal">
			<input type="hidden" name="content" id="content"/>
			<input type="hidden" name="id" id="id" value="${archivefile.id }"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="input-group block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="title" type="text" name="title" class="width-100"  value="${archivefile.title }"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="input-group block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="type" type="text" name="type" class="width-100"  value="${archivefile.type }"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						<label for="keyWork" class="col-sm-3 control-label no-padding-right">关键字：</label>
						<div class="col-sm-9 no-padding">
							<span class="input-group block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="keyWork" type="text" name="keyWork" class="width-100"  value="${archivefile.keyWork }"> 
							</span>
						</div>
					</div>
		</div>
		<div class="col-xs-12">
			<label class="col-xs-3  no-padding-right">档案内容：</label>
			<div class="col-xs-12">
				<textarea id="content" name="content1" cols="100" rows="8" style="width:100%;visibility:hidden;"> ${archivefile.content }</textarea>
			</div>
		</div>
		</form>
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_edit_archivefile">确定</a> 
			<a href="javascript:;" class="btn btn-default btn-sm btn-round" id="btn_cancel_archivefile">返回</a> 
		</div>
</div>
	</div>
</div>
...
<script type="text/javascript">
	seajs.use("rfid/archivefile_edit", function(archivefile_add) {
		archivefile_add.init();
	});
</script>