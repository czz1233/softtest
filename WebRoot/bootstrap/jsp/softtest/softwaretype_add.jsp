...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">新增软件类型</h3>
	</div>
	<div class="panel-body">
		<div class="container-fluid">
			<form id="softwaretype_add_form" class="form-horizontal">
		...
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_add_softwaretype">确定</a> 
...
<script type="text/javascript">
	seajs.use("softtest/softwaretype_add", function(softwaretype_add) {
		softwaretype_add.init();
	});
</script>