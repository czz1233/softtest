...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">新增软件测试用例</h3>
	</div>
	<div class="panel-body">
		<div class="container-fluid">
			<form id="testexample_add_form" class="form-horizontal">
			...
			<div class="form-group">
				<label for="name" class="col-sm-3 control-label no-padding-right">所属软件：</label>
				<div class="col-sm-9 no-padding">
					<span class="block input-icon input-icon-right  col-xs-10 col-sm-5"> 
					<select id="planId" name="planId" class="width-100 form-control">
						<c:forEach items="${testPlanList }" var="ty">
			...
			<div class="form-group">
				...
				<div class="col-sm-9 no-padding">
					<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
						<input id="testEnvironment" type="text" name="testEnvironment" class="width-100"> 
					</span>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="col-xs-12">
				...
				<div class="col-xs-12">
					<textarea id="content" name="content1" cols="100" rows="8" style="width:100%;visibility:hidden;"></textarea>
				</div>
			</div>
		</form>
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_add_testexample">确定</a> 
...
<script type="text/javascript">
	seajs.use("softtest/testexample_add", function(testexample_add) {
		testexample_add.init();
	});
</script>