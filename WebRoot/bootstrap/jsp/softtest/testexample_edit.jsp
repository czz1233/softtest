...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">编辑软件测试用例</h3>
	</div>
	<div class="panel-body">
		<div class="container-fluid">
			<form id="testexample_edit_form" class="form-horizontal">
			<input type="hidden" name="content" id="content" />
			<input type="hidden" name="id" value="${testexample.id }" />
			<div class="form-group">
				<label for="title" class="col-sm-3 control-label no-padding-right">用例标题：</label>
				<div class="col-sm-9 no-padding">
					<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
						<input id="title" type="text" name="title" class="width-100" value="${testexample.title }"> 
					</span>
				</div>
			</div>
			<div class="form-group">
				<label for="testEnvironment" class="col-sm-3 control-label no-padding-right">测试环境：</label>
				<div class="col-sm-9 no-padding">
					<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
						<input id="testEnvironment" type="text" name="testEnvironment" class="width-100" value="${testexample.testEnvironment }"> 
					</span>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea id="remark" name="remark" class="col-xs-10 col-sm-5" rows="3" cols=""> ${testexample.remark }</textarea>
				</div>
			</div>
			<div class="col-xs-12">
				<label class="col-xs-3  no-padding-right">用例内容：</label>
				<div class="col-xs-12">
					<textarea id="content" name="content1" cols="100" rows="8" style="width:100%;visibility:hidden;"> ${testexample.content }</textarea>
				</div>
			</div>
		</form>
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_edit_testexample">确定</a> 
			<a href="javascript:;" class="btn btn-default btn-sm btn-round" id="btn_cancel_testexample">返回</a> 
		</div>
</div>
	</div>
</div>
...
<script type="text/javascript">
	seajs.use("softtest/testexample_edit", function(testexample_edit) {
		testexample_edit.init();
	});
</script>