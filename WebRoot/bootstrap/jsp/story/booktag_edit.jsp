...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="container-fluid">
			<form id="booktag_edit_form" class="form-horizontal">
				<input name="id" type="hidden" value="${booktag.id}" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="id" type="text" name="id" class="width-100" value="${booktag.id}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="account" type="text" name="account" class="width-100" value="${booktag.account}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="section" type="text" name="section" class="width-100" value="${booktag.section}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="sname" type="text" name="sname" class="width-100" value="${booktag.sname}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="sreadNum" type="text" name="sreadNum" class="width-100" value="${booktag.sreadNum}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="swordNum" type="text" name="swordNum" class="width-100" value="${booktag.swordNum}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="sectionStr" type="text" name="sectionStr" class="width-100" value="${booktag.sectionStr}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="supdate" type="text" name="supdate" class="width-100" value="${booktag.supdate}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="status" type="text" name="status" class="width-100" value="${booktag.status}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="createTime" type="text" name="createTime" class="width-100" value="${booktag.createTime}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="creator" type="text" name="creator" class="width-100" value="${booktag.creator}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="storyStr" type="text" name="storyStr" class="width-100" value="${booktag.storyStr}"> 
							</span>
						</div>
					</div>
			</form>
		...
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_edit_booktag">确定</a> 
...
<script type="text/javascript">
	seajs.use("story/booktag_edit", function(booktag_edit) {
		booktag_edit.init();
	});
</script>