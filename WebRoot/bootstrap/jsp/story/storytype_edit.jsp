...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="container-fluid">
			<form id="storytype_edit_form" class="form-horizontal">
				<input name="id" type="hidden" value="${storytype.id}" />
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="name" type="text" name="name" class="width-100" value="${storytype.name}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea id="remark" name="remark" class="col-xs-10 col-sm-5" rows="3" cols="">${storytype.describle}</textarea>
						</div>
					</div>
			</form>
		</div>
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_edit_storytype">确定</a> 
...
<script type="text/javascript">
	seajs.use("story/storytype_edit", function(storytype_edit) {
		storytype_edit.init();
	});
</script>