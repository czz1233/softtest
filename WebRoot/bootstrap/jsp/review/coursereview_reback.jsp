	...
	<div class="panel-body">
		<div class="container-fluid">
			...
			<form id="coursereview_edit_form" class="form-horizontal">
				...
				<input type="hidden" name="reback" id="reback" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="col-xs-10 col-sm-5">${coursereview.content} </div>
						</div>
					</div>
					<div class="form-group">
						<label for="remark" class="col-sm-3 control-label no-padding-right">回复信息：</label>
						<div class="col-sm-9">
...
<script type="text/javascript">
var basePath = "${pageContext.request.contextPath}/";
seajs.use("review/coursereview_reback", function(coursereview_reback) {
	coursereview_reback.init();
});
</script>