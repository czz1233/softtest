...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="container-fluid">
			<form id="coursereview_add_form" class="form-horizontal">
			<input type="hidden" name="content" id="content" />
					<div class="form-group">
						<label for="title" class="col-sm-3 control-label no-padding-right">选择课题：</label>
					...
					<div class="form-group">
						<label for="title" class="col-sm-3 control-label no-padding-right">评论标题：</label>
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="subTitle" type="text" name="subTitle" class="width-100"> 
							</span>
						</div>
					</div>
					<div class="form-group">
		...
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_add_coursereview">确定</a> 
...
<script type="text/javascript">
var basePath = "${pageContext.request.contextPath}/";
seajs.use("review/coursereview_add", function(coursereview_add) {
	coursereview_add.init();
});
</script>