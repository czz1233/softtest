					...
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="name" type="text" name="name" class="width-100" value="${role.name}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea id="describle" name="describle" class="col-xs-10 col-sm-5" rows="3" cols="">${role.describle}</textarea>
						</div>
					</div>
			</form>
		</div>
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_edit_role">确定</a> 
...
<script type="text/javascript">
	seajs.use("system/role_edit", function(role_edit) {
		role_edit.init();
	});
</script>