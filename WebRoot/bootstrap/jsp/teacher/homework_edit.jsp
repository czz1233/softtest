...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="container-fluid">
			<form id="homework_edit_form" class="form-horizontal">
				<input name="id" type="hidden" value="${homework.id}" />
				<input type="hidden" name="content" id="content" />
					<div class="form-group">
						<label for="title" class="col-sm-3 control-label no-padding-right">作业标题：</label>
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="title" type="text" name="title" class="width-100" value="${homework.title}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						<label for="course" class="col-sm-3 control-label no-padding-right">所属课程：</label>
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input type="text"  class="width-100" value="${homework.courseStr}" disabled="disabled"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						<label for="endTime" class="col-sm-3 control-label no-padding-right">完成时间：</label>
						<div class="col-sm-5">
							<div class="input-append date form_datetime input-group col-sm-9" data-date-format="yyyy-mm-dd hh:ii">
								<input id="endTime" name="endTime" readonly="readonly" class="col-xs-12 form-control"  type="text" value="${homework.endTimeStr }" />
					...
					<div class="form-group">
						<label for="remark" class="col-sm-3 control-label no-padding-right">作业内容：</label>
						<div class="col-sm-9">
							<textarea id="content_ke" name="content_ke" class="col-xs-10 col-sm-5" rows="3" cols="" style="width:100%;visibility:hidden;">${homework.content} </textarea>
						</div>
					</div>
			</form>
		</div>
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_edit_homework">确定</a> 
			<a href="javascript:;" class="btn btn-default btn-sm btn-round" id="btn_cancel_homework">返回</a> 
		</div>
	</div>
</div>
<!-- ------------------------------------------------------------------------------------ -->
...
<script type="text/javascript">
var basePath = "${pageContext.request.contextPath}/";
seajs.use("teacher/homework_edit", function(homework_edit) {
	homework_edit.init();
});
</script>