...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="container-fluid">
			<form id="homework_add_form" class="form-horizontal">
				<input type="hidden" name="content" id="content" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea id="content_ke" name="content_ke" class="col-xs-10 col-sm-5" rows="3" cols="" style="width:100%;visibility:hidden;"> </textarea>
						</div>
					</div>
			</form>
		</div>
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_add_homework">确定</a> 
...
<script type="text/javascript">
var basePath = "${pageContext.request.contextPath}/";
seajs.use("teacher/homework_add", function(homework_add) {
	homework_add.init();
});
</script>