...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">新增课程资料</h3>
	</div>
	<div class="panel-body">
		<div class="container-fluid">
			<form id="datainfo_add_form" class="form-horizontal">
				<input type="hidden" id="data_url_id" name="dataUrl" />
					...
					<div class="form-group">
						<label for="title" class="col-sm-3 control-label no-padding-right">所属课程：</label>
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
					...
					<div class="form-group">
						<label for="dataUrl" class="col-sm-3 control-label no-padding-right">资料信息：</label>
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
		...
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_add_datainfo">确定</a> 
...
<script type="text/javascript">
	seajs.use("teacher/datainfo_add", function(datainfo_add) {
		datainfo_add.init();
	});
</script>