...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="container-fluid">
			<form id="course_edit_form" class="form-horizontal">
				...
				<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="name" type="text" name="name" class="width-100" value="${course.name}"> 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-append date form_datetime input-group col-sm-9" data-date-format="yyyy-mm-dd hh:ii">
								<input id="beginTime" name="beginTime" readonly="readonly" class="col-xs-12 form-control"  type="text"  value="${course.beginTimeStr}"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-append date form_datetime input-group col-sm-9" data-date-format="yyyy-mm-dd hh:ii">
								<input id="endTime" name="endTime" readonly="readonly" class="col-xs-12 form-control"  type="text"   value="${course.endTimeStr}"/>
							    <span class="input-group-addon">
									<i class="fa fa-times bigger-110"></i>
								</span>
								<span class="input-group-addon">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="place" type="text" name="place" class="width-100"   value="${course.place}" > 
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
								<input id="describle" type="text" name="describle" class="width-100" value="${course.describle}"> 
							</span>
						</div>
					</div>
			</form>
		...
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_edit_course">确定</a> 
...
<script type="text/javascript">
	seajs.use("teacher/course_edit", function(course_edit) {
		course_edit.init();
	});
</script>