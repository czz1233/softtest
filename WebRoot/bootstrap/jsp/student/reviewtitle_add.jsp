...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">发起话题</h3>
	</div>
	<div class="panel-body">
		<div class="container-fluid">
			<form id="reviewtitle_add_form" class="form-horizontal">
					...
					<div class="form-group">
						<label for="subTitle" class="col-sm-3 control-label no-padding-right">子标题：</label>
						<div class="col-sm-9 no-padding">
							<span class="block input-icon input-icon-right col-xs-10 col-sm-5"> 
		...
		<div class="col-xs-12 col-md-12 col-md-12 center">
			<a href="javascript:;" class="btn btn-success btn-sm btn-round" id="btn_add_reviewtitle">确定</a> 
...
<script type="text/javascript">
	seajs.use("student/reviewtitle_add", function(reviewtitle_add) {
		reviewtitle_add.init();
	});
</script>