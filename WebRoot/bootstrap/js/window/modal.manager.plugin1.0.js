...
(function($,w){
	...
	'<p>@{msgContent}</p></div>  <div class="modal-footer"><button role="button" class="btn btn-primary JConfirmBtn btn-sm btn-round">确定</button></div>';

	var confirmTemplate='<div class="modal-header"><h4 class="modal-title">@{title}</h4> </div><div class="modal-body">'+
	'<p>@{msgContent}</p></div>  <div class="modal-footer"><button role="button" class="btn btn-success JConfirmBtn btn-sm btn-round">确定</button>'+
	'<button role="button" class="btn btn-default JCancelBtn btn-sm btn-round">取消</button></div>';

	var promptTemplate='<div class="modal-header"><h4 class="modal-title">@{title}</h4></div><div class="modal-body">'+
	'<p>@{msgContent}</p><input type="text" class="form-control JPromptInput" value="@{defaultVal}" placeholder="请输入..."/></div>  <div class="modal-footer"><a role="button" class="btn btn-success JConfirmBtn btn-sm btn-round">确定</a>'+
	'<a role="button" class="btn btn-default JCancelBtn btn-sm btn-round">取消</a></div>';
	...
	$.extend(dialog,{
		fCreate:function(config){
			...
			if(width){
				modalStart='<div class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true" data-backdrop="static" id="@{modalId}">'+
