	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
			...
			if(!node.iconSkin){	
				...
				html.push("<span id='", node.tId, consts.id.ICON,
						"' title='' treeNode", consts.id.ICON," class='' style='", view.makeNodeIcoStyle(setting, node), "'></span><span id='", node.tId, consts.id.SPAN,
						"'><i class='" + node.iconSkin + " icon-large'></i>  ",name,"</span>");
			}
		},
