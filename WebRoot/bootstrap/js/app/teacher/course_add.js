define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			addRecord:function(){
				...
				$.ajax({
					url: basePath + "teacher/course/save",
					data:$("#" + moudle.exports.formID).serialize(),
					type:"POST",
					dataType:"JSON",
					success:function(msg){
						if(msg.ok){
							util.showMsg("success","操作成功","新增课程成功");
			...
			validateAddForm:function(){
				var rules = {				
									...
									place:{required: true,maxlength:120}
			...
			listener:function(){
				var items = [
				             {id: '#btn_add_course',click:moudle.exports.addRecord},
