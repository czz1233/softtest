define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			editRecord:function(){
				...
				$.ajax({
					url: basePath + "teacher/course/edit",
					data:$("#" + moudle.exports.formID).serialize(),
					type:"POST",
					dataType:"JSON",
					success:function(msg){
						if(msg.ok){
							util.showMsg("success","操作成功","编辑课程成功");
			...
			validateEditForm:function(){
				var rules = {			
									...
									place:{required: true,maxlength:120,charVal:"#place"}
			...
			listener:function(){
				var items = [
				             {id: '#btn_edit_course',click:moudle.exports.editRecord},
				             {id: '#btn_cancel_course',click:moudle.exports.cancelRecord}
							];
