define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			addRecord:function(){
				...
				$.ajax({
					url: basePath + "student/reviewtitle/save",
					data:$("#" + moudle.exports.formID).serialize(),
					type:"POST",
					dataType:"JSON",
					success:function(msg){
						if(msg.ok){
							util.showMsg("success","操作成功","新增发起话题成功");
			...
			listener:function(){
				var items = [
				             {id: '#btn_add_reviewtitle',click:moudle.exports.addRecord},
