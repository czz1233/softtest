define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			editRecord:function(){
				...
				$.ajax({
					url: basePath + "story/section/edit",
			...
			listener:function(){
				var items = [
				             {id: '#btn_edit_section',click:moudle.exports.editRecord},
				             {id: '#btn_cancel_section',click:moudle.exports.cancelRecord}
							];
