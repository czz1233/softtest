define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			editRecord:function(){
				...
				$.ajax({
					url: basePath + "story/storytype/edit",
			...
			listener:function(){
				var items = [
				             {id: '#btn_edit_storytype',click:moudle.exports.editRecord},
				             {id: '#btn_cancel_storytype',click:moudle.exports.cancelRecord}
							];
