define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			editRecord:function(){
				...
				$.ajax({
					url: basePath + "story/booktag/edit",
			...
			validateEditForm:function(){
				var rules = {			
									...
									section:{required: true,maxlength:120,charVal:"#section"},
									sname:{required: true,maxlength:120,charVal:"#sname"},
									sreadNum:{required: true,maxlength:120,charVal:"#sreadNum"},
									swordNum:{required: true,maxlength:120,charVal:"#swordNum"},
									sectionStr:{required: true,maxlength:120,charVal:"#sectionStr"},
									supdate:{required: true,maxlength:120,charVal:"#supdate"},
									...
									storyStr:{required: true,maxlength:120,charVal:"#storyStr"},
			...
			listener:function(){
				var items = [
				             {id: '#btn_edit_booktag',click:moudle.exports.editRecord},
