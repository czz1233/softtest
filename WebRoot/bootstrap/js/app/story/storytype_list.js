...
define(function(require, exports, moudle) {
	...
	moudle.exports = {
			tableId:"storytype_table",
			tableInit:function(){
				var param = {};
				param.tableId = moudle.exports.tableId;
				param.serverSide = false;
				var url = basePath + "story/storytype/getTableData";
				param.columns = [
							{"data":"name"},
							{"data":"describle"},
							{"data":"createTime"},
			...
			addRecordShow:function(){
				var url = basePath + "story/storytype/addRecordShow";
				$("#main-content").load(url);
			},
			editRecordShow:function(id){
				var url = basePath + "story/storytype/" + id +"/editRecordShow";
				$("#main-content").load(url);
			},
			deleteRecord:function(id){
				winUtil.confirm("操作确认","您确定删除该条记录吗?",function(){
					$.ajax({
						url:basePath + "story/storytype/deleteStoryType",
						data:{"id":id},
						type:"POST",
						dataType:"JSON",
