			...
			tableInit:function(){
				...
				param.columnDefs = [{"render":function (data, type, row) {
				                    ...
				                    {"render":function (data, type, row) {
				                    	var sureButton = $("<label>&nbsp;&nbsp;<button type='button' class='but-row-sure btn btn-minier btn-success btn-round'><i class='fa fa-pencil bigger-110'></i>  接受订单</button><label>");
				...
				winUtil.confirm("操作确认","您确定取消该订单么?",function(){
					$.ajax({
						...
						success:function(msg){
							if(msg.ok){
								util.showMsg("success","操作成功","您确定取消该订单么");
