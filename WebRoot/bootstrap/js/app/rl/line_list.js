...
define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			tableInit:function(){
				...
				var url = basePath + "rl/line/getTableData";
				param.columns = [
							{"data":"title"},
							{"data":"type"},
							{"data":"content"},
			...
			addRecordShow:function(){
				var url = basePath + "rl/line/addRecordShow";
				$("#main-content").load(url);
			},
			editRecordShow:function(id){
				var url = basePath + "rl/line/" + id +"/editRecordShow";
				$("#main-content").load(url);
			},
			deleteRecord:function(id){
				winUtil.confirm("操作确认","您确定删除该条记录吗?",function(){
					$.ajax({
						url:basePath + "rl/line/deleteLine",
						data:{"id":id},
						type:"POST",
						dataType:"JSON",
						success:function(msg){
							if(msg.ok){
								util.showMsg("success","操作成功","您已经成功删除路线信息");
