define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			addRecord:function(){
				...
				$.ajax({
					url: basePath + "rl/talk/save",
					data:$("#" + moudle.exports.formID).serialize(),
					type:"POST",
					dataType:"JSON",
					success:function(msg){
						if(msg.ok){
							util.showMsg("success","操作成功","新增发布留言成功");
			...
			validateAddForm:function(){
				var rules = {				
									...
									reback:{required: true,maxlength:120},
									rebackTime:{required: true,maxlength:120},
									status:{required: true,maxlength:120},
									creator:{required: true,maxlength:120},
									sendUser:{required: true,maxlength:120},
									rebackUser:{required: true,maxlength:120},
									sendUserStr:{required: true,maxlength:120},
									rebackUserStr:{required: true,maxlength:120},
			...
			listener:function(){
				var items = [
				             {id: '#btn_add_talk',click:moudle.exports.addRecord},
