define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			editRecord:function(){
				...
				$.ajax({
					url: basePath + "softtest/testplantype/edit",
			...
			listener:function(){
				var items = [
				             {id: '#btn_edit_testplantype',click:moudle.exports.editRecord},
				             {id: '#btn_cancel_testplantype',click:moudle.exports.cancelRecord}
							];
