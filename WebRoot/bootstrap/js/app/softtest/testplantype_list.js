...
define(function(require, exports, moudle) {
	...
	moudle.exports = {
			tableId:"testplantype_table",
			tableInit:function(){
				var param = {};
				param.tableId = moudle.exports.tableId;
				param.serverSide = false;
				var url = basePath + "softtest/testplantype/getTableData";
				param.columns = [
							{"data":"name"},
							{"data":"remark"},
							{"data":"createTime"},
			...
			addRecordShow:function(){
				var url = basePath + "softtest/testplantype/addRecordShow";
			...
			deleteRecord:function(id){
				winUtil.confirm("操作确认","您确定删除该条记录吗?",function(){
					$.ajax({
						url:basePath + "softtest/testplan/deleteTestPlan",
						data:{"id":id},
						type:"POST",
						dataType:"JSON",
