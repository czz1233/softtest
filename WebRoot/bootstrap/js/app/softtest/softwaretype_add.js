define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			addRecord:function(){
				...
				$.ajax({
					url: basePath + "softtest/softwaretype/save",
					data:$("#" + moudle.exports.formID).serialize(),
					type:"POST",
					dataType:"JSON",
					success:function(msg){
						if(msg.ok){
							util.showMsg("success","操作成功","新增软件类型成功");
			...
			listener:function(){
				var items = [
				             {id: '#btn_add_softwaretype',click:moudle.exports.addRecord},
