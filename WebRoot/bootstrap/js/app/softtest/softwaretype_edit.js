define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			editRecord:function(){
				...
				$.ajax({
					url: basePath + "softtest/softwaretype/edit",
					data:$("#" + moudle.exports.formID).serialize(),
					type:"POST",
					dataType:"JSON",
					success:function(msg){
						if(msg.ok){
							util.showMsg("success","操作成功","编辑软件类型成功");
			...
			listener:function(){
				var items = [
				             {id: '#btn_edit_softwaretype',click:moudle.exports.editRecord},
				             {id: '#btn_cancel_softwaretype',click:moudle.exports.cancelRecord}
							];
