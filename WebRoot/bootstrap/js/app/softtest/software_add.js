define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			addRecord:function(){
				...
				$.ajax({
					url: basePath + "softtest/software/save",
			...
			validateAddForm:function(){
				var rules = {				
									...
									vision:{required: true,maxlength:120},
									environment:{required: true,maxlength:120}
			...
			listener:function(){
				var items = [
				             {id: '#btn_add_software',click:moudle.exports.addRecord},
				             {id: '#btn_cancel_software',click:moudle.exports.cancelRecord}
							];
