define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			addRecord:function(){
				...
				$.ajax({
					url: basePath + "rfid/liverecord/save",
					data:$("#" + moudle.exports.formID).serialize(),
					type:"POST",
					dataType:"JSON",
					success:function(msg){
						if(msg.ok){
							util.showMsg("success","操作成功","新增调档记录成功");
			...
			validateAddForm:function(){
				var rules = {				
									liveUser:{required: true,maxlength:120}
			...
			listener:function(){
				var items = [
				             {id: '#btn_add_liverecord',click:moudle.exports.addRecord},
