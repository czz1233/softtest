define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			editRecord:function(){
				...
				$.ajax({
					url: basePath + "rfid/archive/edit",
					data:$("#" + moudle.exports.formID).serialize(),
					type:"POST",
					dataType:"JSON",
					success:function(msg){
						if(msg.ok){
							util.showMsg("success","操作成功","编辑档案成功");
			...
			validateEditForm:function(){
				var rules = {			
									...
									elTag:{required: true,maxlength:120,charVal:"#elTag"},
									loacation:{required: true,maxlength:120,charVal:"#loacation"}
							};			
			...
			listener:function(){
				var items = [
				             {id: '#btn_edit_archive',click:moudle.exports.editRecord},
				             {id: '#btn_cancel_archive',click:moudle.exports.cancelRecord}
							];
