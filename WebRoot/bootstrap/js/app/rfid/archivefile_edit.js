define(function(require, exports, moudle) {
	...
	moudle.exports = {
			...
			editRecord:function(){
				...
				$("#content").val(content);
				$.ajax({
					url: basePath + "rfid/archivefile/edit",
					data:$("#" + moudle.exports.formID).serialize(),
					type:"POST",
					dataType:"JSON",
					success:function(msg){
						if(msg.ok){
							util.showMsg("success","操作成功","编辑文档成功");
			...
			listener:function(){
				var items = [
				             {id: '#btn_edit_archivefile',click:moudle.exports.editRecord},
				             {id: '#btn_cancel_archivefile',click:moudle.exports.cancelRecord}
							];
