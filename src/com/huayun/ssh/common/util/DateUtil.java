...
public class DateUtil{
	    ...
	    public static Date getDate(String date) {
	        ...
	        try
	        {
	            ...
	            return getFormatInstance(DATAFORMAT_STR).parse(date);
	     ...
	     * @return eg:20080707
	     */
	    public static synchronized String getStringDate(Date d) {
	        if (d == null)
	        {
	            return "";
	        }
	    ...
	    public static String getNowStr(){
	    	Date date = new Date();
	    	return DateUtil.formatDate(date, DateUtil.DATATIMEF_STR);
	    }
	    // /**
	    // * 国际化。
	    // */
