			    ...
			    throws BeansException
			  {
			    ...
			    for (PropertyDescriptor targetPd : targetPds) {
			      if ((targetPd.getWriteMethod() == null) || (
			        (ignoreProperties != null) && (ignoreList.contains(targetPd.getName())))) continue;
			      ...
			      try {
					...
					if (value != null && !(value instanceof List<?>) && !(value instanceof Set<?>) && !(value instanceof Collection<?>) && !(value instanceof Map<?,?>)) {
